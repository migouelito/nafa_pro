          ...
          Obx(() => Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: controller.selectedCount > 0
                      ? AppColors.generalColor.withOpacity(0.4)
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    "${controller.selectedCount} produit(s) sélectionné(s)",
                    style: TextStyle(
                      fontSize: 12,
 ...
 Widget _buildStockList() {
  return ListView.builder(
    ...
    itemBuilder: (c, i) {
      ...
      return Obx(() => _buildStockItem(item, id));
    },
  );
}


Widget _buildStockItem(Map<String, dynamic> item, String id) {
  final isSelected = controller.selectedProducts[id]?.value ?? false;
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      border: Border.all(
        color: isSelected
            ? AppColors.generalColor.withOpacity(0.5)
            : Colors.grey.shade100,
      ),
      boxShadow: [
      ...
      children: [
        Row(
          children: [
            ...
            Expanded(
              ...
              value: isSelected,
              onChanged: (v) => controller.toggleProduct(id, v!),
            ),
          ],
        ),
        const SizedBox(height: 15),
        Opacity(
          ...
          child: IgnorePointer(
            ...
            child: Row(
              children: [
                Expanded(child: _qtyInput(
                  PhosphorIcons.arrowsClockwise(PhosphorIconsStyle.fill),
                  "Recharge",
                  controller.countersRecharge[id]!,
                  AppColors.generalColor,
                  stockR,
                )),
  ...
  Widget _buildSessionCard(Map<String, dynamic> session) {
    ...
    if (items.isNotEmpty) {
      rawCreatedDate = session['created'];//items[0]['created']?.toString() ?? "";
    }
    print("=======items$items");
